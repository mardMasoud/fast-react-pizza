...
import { addToCart, increase, getCart, getCurrentQuantityById } from "../cart/cartSlice";
...
function MenuItem({ pizza }) {
    ...
    function handleClick() {
        ...
        if (cart.findIndex((index) => index.id === id) !== -1) dispatch(increase(id));
        ...
        <li className="flex gap-4 py-2">
            ...
            <div className="flex grow flex-col pt-0.5">
                ...
                <div className="mt-auto flex items-center justify-between">
                    ...
                    {curruntQuantityById && <DeleteItem id={id} />}
